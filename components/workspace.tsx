    ...
    <div className="app-shell">
      ...
      <main id="main" className="workspace">
        <div className="workspace-heading">
          <div>
            <p className="eyebrow">YOUR PRACTICE WORKSPACE</p>
            <h1>
              {isReport
                ? 'From your answer to understanding'
                : revising
                  ? 'Give your reasoning another look'
                  : 'Make your reasoning count'}
              <span>.</span>
            </h1>
              ...
              <div className="workspace-grid">
                  ...
                  <form className="input-body" onSubmit={analyze} noValidate>
                        ...
                        {session?.demo && (
                          <div className="sample-revision">
                            ...
                            <p>
                              ...
                              comparison. An answer you edit requires the live
                              AI engine.
                            </p>
                            <Button
                              type="button"
                    ...
                    <details className="additional">
                      ...
                      <fieldset disabled={busy || revising}>
                        ...
                        <p className="field-hint">
                          Older questions retain their supplied scoring
                          structure. No rubric? We create and save a clearly
                          labeled practice rubric before grading.
                        </p>
                      </fieldset>
                    </details>
                    ...
                    <div className="save-preference">
                      ...
                      <label htmlFor="save-history">
                        ...
                        <span>
                          Optional. Local history stays on this device and can
                          be deleted anytime.
                        </span>
                      </label>
                    </div>
                    <div className="form-actions">
                      <p>
                        <LockKeyhole size={15} />
                        <span>
                          Your question, answer, and additional materials will
                          be sent to {config?.provider || 'OpenAI'} for
                          analysis. No name or email needed.
                        </span>
                      </p>
                ...
                <aside className="side-column">
                  <section className="guide-card">
                    ...
                    <p>
                      Feedback that connects your work to what the question
                      actually asks.
                    </p>
                    <div className="guide-item">
                      ...
                      <div>
                        ...
                        <p>
                          Understand each scoring decision with evidence from
                          your answer.
                        </p>
                      </div>
                    </div>
                    <div className="guide-item">
                      ...
                      <div>
                        ...
                        <p>
                          Get specific corrections and a focused revision plan.
                        </p>
                      </div>
                    </div>
                    <div className="guide-item">
                      ...
                      <div>
                        ...
                        <p>
                          Try a short follow-up question where you need it most.
                        </p>
                      </div>
                    </div>
